            ...
            <li className="list-group-item event-li" key={event.event_id}>
              <div className="row row-event-owner">
                <div>
                  ...
                  <img className="owner-image-bg" src={circle} />
                  <img className="owner-image" src={event.user_image_url} alt="host picture"/>
                  </Link>
                </div>
              ...
              <div className="row row-event-info">
                ...
                <div className="event-image-holder">
                  <img className="event-image-bg" src={circle} />
                  <img className="event-image" src={event.event_icon_url} alt="event icon" /><br />
                </div>
                <div className="oval"
